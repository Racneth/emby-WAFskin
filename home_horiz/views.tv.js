define(['./spotlight', 'focusManager', 'pluginManager', 'cardBuilder', './../skininfo', 'emby-itemscontainer'], function (spotlight, focusManager, pluginManager, cardBuilder, skinInfo) {
    'use strict';
